...
namespace API_Template
{
    class Program
    {
        ...
        {
            var client = new RestClient("https://api.nobelprize.org/2.0/laureates?_ga=2.203993104.1813067937.1612861438-1845238578.1612861438");
            ...
            foreach (Laureate item in root.laureates)
            {
                Console.WriteLine(item.fullName.en);

                Console.WriteLine(item.nobelPrizes[0].category.en);
            }
            Console.ReadLine();
